(function() {
    var h = {}, mt = {}, c = {id: "96801ca9ab090e6db01b2b8377a4e979",dm: ["youzan.com"],js: "tongji.baidu.com/hm-web/js/",etrk: [],icon: '',ctrk: false,align: -1,nv: -1,vdur: 1800000,age: 31536000000,rec: 0,rp: [],trust: 0,vcard: 0,qiao: 0,lxb: 0,conv: 0,comm: 0,apps: ''};
    var p = !0, q = null, r = !1;
    mt.j = {};
            ...
            switch (typeof d) {
                ...
                default:
                    ...
                    if (d instanceof Array) {
                        var e = ["["], l = d.length, n, f, m;
                        for (f = 0; f < l; f++)
                            switch (m = d[f], typeof m) {
                                case "undefined":
                                case "function":
                                case "unknown":
                                    break;
                                default:
                                    n && e.push(","), e.push(mt.i.stringify(m)), n = 1
                            }
                        e.push("]");
                        return e.join("")
                    }
    ...
    (function() {
        ...
        function d(a) {
            if (!("focus" == a.type || "blur" == a.type) || !(a.target && a.target != window))
                k = "focus" == a.type || "focusin" == a.type ? p : r, b()
        }
        var g = mt.event, l = h.C, n = p, f = p, m = p, k = p, v = +new Date, t = v, s = 0, u = p, w = e("visibilityState"), y = e("hidden"), x;
        b();
        (function() {
    ...
    (function() {
        var a = mt.lang, b = h.p, e = h.load, d = {ma: function(d) {
        ...
        function a(m) {
            for (var b in m)
                if ({}.hasOwnProperty.call(m, b)) {
                    var d = m[b];
                    e.e(d, "Object") || e.e(d, "Array") ? a(d) : m[b] = String(d)
                }
        }
        function b(a) {
            return a.replace ? a.replace(/'/g, "'0").replace(/\*/g, "'1").replace(/!/g, "'2") : a
        }
        var e = mt.lang, d = mt.i, g = h.p, l = h.C, n = h.Y, f = {N: q,o: [],z: 0,O: r,init: function() {
                f.d = 0;
                f.N = {push: function() {
                ...
                if (0 < f.o.length)
                    for (var a = 0, b = f.o.length; a < b; a++)
                        f.I(f.o[a]);
                f.o = q
            },I: function(a) {
                if (e.e(a, "Array")) {
                ...
                if (a = {webim: 1,tel: 2,map: 3,sms: 4,callback: 5,share: 6}[a[1]])
                    f.d |= 32, h.b.a.et = 93, h.b.a.ep = a, h.b.g()
                ...
                if (e.e(b, "Object")) {
                    ...
                    if (900 >= l)
                        ...
                        for (var l = Math.ceil(l / 900), t = "block|" + Math.round(Math.random() * g.Q).toString(16) + "|" + l + "|", s = [], u = 0; u < l; u++)
                            s.push(u), s.push(b.substring(900 * u, 900 * u + 900)), k.call(this, t + s.join("|")), 
                            s = []
                }
    ...
    (function() {
        ...
        var b = mt.url, e = mt.S, d = mt.K, g = mt.lang, l = mt.cookie, n = mt.j, f = mt.localStorage, m = mt.sessionStorage, k = h.p, v = h.C;
        a.prototype = {H: function(a, b) {
                ...
                for (var a = 0, b = c.dm.length; a < b; a++) {
                    var d = c.dm[a];
                    if (-1 < d.indexOf("/") && this.P(document.location.href, d))
                        return d.replace(/^[^\/]+(\/.*)/, "$1") + "/"
                }
                return "/"
            },ea: function() {
                ...
                try {
                    return l.get(a) || m.get(a) || f.get(a)
                } catch (b) {
                }
            },setData: function(a, b, d) {
                try {
                    l.set(a, b, {domain: this.F(),path: this.L(),D: d}), d ? f.set(a, b, d) : m.set(a, b)
                } catch (e) {
                }
            },oa: function(a) {
                try {
                    l.set(a, "", {domain: this.F(),path: this.L(),D: -1}), m.remove(a), f.remove(a)
                } catch (b) {
                }
            },ta: function() {
                var a, b, d, e, f;
                ...
                var a = document.location.hash.substring(1), d = RegExp(c.id), e = -1 < document.referrer.indexOf(k.V) ? p : r, f = b.h(a, "jn"), g = /^heatlink$|^select$/.test(f);
    ...
    (function() {
        var a = mt.q, b = mt.event, e = mt.url, d = mt.i;
        try {
            if (window.performance && performance.timing && "undefined" !== typeof h.b) {
                ...
                var f = function() {
                    ...
                    f = l("navigation");
                    b = l("request");
                    f = {netAll: b.start - f.start,netDns: l("domainLookup").value,netTcp: l("connect").value,srv: l("response").start - b.start,dom: performance.timing.domInteractive - 
                        performance.timing.fetchStart,loadEvent: l("loadEvent").end - f.start};
                    a = document.referrer;
                    var s = q;
                    b = q;
                    if ("www.baidu.com" === (a.match(/^(http[s]?:\/\/)?([^\/]+)(.*)/) || [])[2])
                        s = e.h(a, "qid"), b = e.h(a, "click_t");
                    a = s;
                    f.qid = a != q ? a : "";
                    b != q ? (f.bdDom = n ? n - b : 0, f.bdRun = g - b, f.bdDef = l("navigation").start - b) : (f.bdDom = 0, f.bdRun = 0, f.bdDef = 0);
                    h.b.a.et = 87;
    ...
    (function() {
        var a = mt.lang, b = mt.event, e = mt.i;
        if (c.comm && "undefined" !== typeof h.b) {
            var d = function(a) {
                ...
                return [].slice.call(a)
            }, g = /.*\/swt(\/)?([\?|#].*)?$/i, l = {click: function() {
                    for (var a = [], b = d(document.getElementsByTagName("a")), b = [].concat.apply(b, d(document.getElementsByTagName("area"))), b = [].concat.apply(b, d(document.getElementsByTagName("img"))), e = /openZoosUrl\(|swt/, f = /\/LR\/Chatpre\.aspx/, k = 0, m = b.length; k < m; k++) {
                        var l = b[k], n = l.getAttribute("onclick"), 
                        l = l.getAttribute("href");
                        (e.test(n) || f.test(l) || g.test(l)) && a.push(b[k])
                    }
                    return a
                }}, n = function(a, b) {
                for (var d in a)
                ...
                for (f = +new Date; 500 >= +new Date - f; )
                    ;
            }, m, k = "/zoosnet" + (/\/$/.test("/zoosnet") ? "" : "/"), v = function(b, d) {
                if (m === d)
                    return f(k + b, d), r;
                if (a.e(d, "Array") || a.e(d, "NodeList"))
                    for (var e = 0, g = d.length; e < g; e++)
                        if (m === d[e])
                            return f(k + b + "/" + (e + 1), d[e]), r
            };
            b.c(document, "click", function(b) {
                ...
                }); m && m !== document && n(d, v) !== r; )
                    m = m.parentNode
            })
        }
    })();
    (function() {
        var a = mt.event, b = mt.i;
        if (c.comm && "undefined" !== typeof h.b) {
