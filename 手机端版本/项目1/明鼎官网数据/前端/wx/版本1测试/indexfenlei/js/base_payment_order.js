...
window.zenjs = window.zenjs || {}, function(e) {
    ...
    var i = e("zenjs/class"), o = e("zenjs/core/trigger_method"), r = i.extend({on: function(e, t, n) {
    ...
    var n = e("zenjs/events"), i = window.zenjs.UA, o = window.zenjs.Args, r = window.getShareData, a = n.extend({init: function(e) {
...
FastClick.prototype.needsClick = function(e) {
    ...
    e.Browser = {cookie: function() {
            var e = new Date, t = +e, n = 864e5, i = function(e) {
                ...
                var i = [];
                for (var o in e)
                    i.push(encodeURIComponent(o) + "=" + (n ? encodeURIComponent(e[o]) : e[o]));
                return i.join(t || ",")
            };
            return function(r, a) {
                if (void 0 === a)
...
}(window.zenjs), define("zenjs/util/cookie", function() {
}), define("wap/base/base", ["wap/base/log", "zenjs/util/ua", "vendor/fastclick_release", "zenjs/util/cookie"], function() {
    ...
    /loaded|interactive|complete/.test(document.readyState) ? h() : window.addEventListener("load", h);
    var p = function(e) {
        var t = new Image;
    ...
    if ("object" == typeof window.localStorage)
        try {
            var w = localStorage.getItem("canwebp");
            "ok" == w ? zenjs.Browser.cookie("_canwebp", {value: "1",path: "/",domain: "koudaitong.com",expires: 3650}) : "no" != w && p(function(e) {
                localStorage.setItem("canwebp", e ? "ok" : "no"), e && zenjs.Browser.cookie("_canwebp", {value: "1",path: "/",domain: "koudaitong.com",expires: 3650})
            })
        } catch (v) {
        }
    
}), require(["wap/base/fullguide", "wap/base/log", "wap/base/lazy_load", "wap/base/js_bridge", "wap/base/wx", "wap/base/motify", "wap/components/footer_auto", "wap/base/base"], function() {
