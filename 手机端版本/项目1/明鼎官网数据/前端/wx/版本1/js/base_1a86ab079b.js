...
}(window.zenjs), define && define("components/zenjs/util/ua", [], function() {
    return window.zenjs.UA
}), define("wap/base/fullguide", ["components/zenjs/util/ua"], function(e) {
    var t = window.Zepto || window.jQuery || t, n = window._global, i = t("body"), o = zenjs.UA.isWeixin() && n.mp_data && +n.mp_data.quick_subscribe && n.mp_data.quick_subscribe_url, r = {fav: function() {
        ...
        t(a[e]).length ? o = t(a[e]) : (i = r[e](n || {}), o = t(i).appendTo("body")), o.removeClass("hide")
            ...
            var t = n.mp_data;
            if (t)
                return !(e || {}).goods && o ? void (window.location.href = t.quick_subscribe_url) : void s("follow", t)
        },browser: function(e) {
...
FastClick.prototype.needsClick = function(e) {
    ...
    e.Args = {getParameterByName: function(e, t) {
            ...
            return function(t, n) {
                if (!t || 0 === t.length || 0 === $.trim(t).indexOf("javascript"))
                    return "";
...
}(window.zenjs), define("components/zenjs/util/args", function() {
}), define("wap/base/log", ["components/zenjs/util/args"], function() {
    ...
    var n = function() {
        ...
        e = e || "default";
        var t = {wxd: "http://fx.tj.youzan.com/3.gif",wxdapp: "http://app.tj.koudaitong.com/1.gif","default": "http://tj.koudaitong.com/1.gif"};
        return t[e]
    };
    t.log = function(n, r) {
    ...
    e.Image = e.Image || {}, e.Image.toWebp = function() {
        ...
        return function(n) {
            ...
            if (t) {
                var r = i.match(e);
                r && r.length >= 4 && ("+2x" == r[4] && (o = 2), i = i.replace(e, ".") + r[1] + "?imageView2/2/w/" + parseInt(r[2]) * o + "/h/" + parseInt(r[3]) * o + "/q/90/format/" + ("gif" == r[1] ? "gif" : "webp"))
            }
            return i
        }
    }()
}(window.zenjs), define("zenjs/util/image", function() {
}), define("wap/base/lazy_load", ["wap/base/log", "zenjs/util/image"], function() {
    ...
    e.fn.lazyload = function(n) {
        ...
        var o, r = this, a = {threshold: 200,failure_limit: 0,event: "scroll",effect: "show",container: window,data_attribute: "src",skip_invisible: !1,appear: null,load: null,placeholder: null};
        return n && (void 0 !== n.failurelimit && (n.failure_limit = n.failurelimit, delete n.failurelimit), void 0 !== n.effectspeed && (n.effect_speed = n.effectspeed, delete n.effectspeed), e.extend(a, n)), o = void 0 === a.container || a.container === window ? t : e(a.container), 0 === a.event.indexOf("scroll") && o.bind(a.event, function() {
            ...
            var t = this, n = e(t);
            t.loaded = !1, (void 0 === n.attr("src") || n.attr("src") === !1) && n.is("img") && a.placeholder && n.attr("src", a.placeholder), n.one("appear", function() {
                if (!this.loaded) {
                    if (a.appear) {
                        var i = r.length;
                        a.appear.call(t, i, a)
                    }
                    var o = n.attr("data-" + a.data_attribute);
                    o = zenjs.Image.toWebp(o), o = o.replace(/http:\/\/imgqn.koudaitong.com/gi, "http://img.yzcdn.cn"), e("<img />").bind("load", function() {
                        n.hide(), n.is("img") ? n.attr("src", o) : n.css("background-image", 'url("' + o + '")'), n[a.effect](), t.loaded = !0;
                        var i = e(t).parent();
                        i.hasClass("photo-block") && i.css("background-color", "#fff");
                        var s = e.grep(r, function(e) {
                            return !e.loaded
                        });
                        if (r = e(s), a.load) {
                            var l = r.length;
...
}(window.zenjs), define("components/zenjs/util/str/unescape", function() {
}), define("wap/base/share", ["components/zenjs/util/args", "components/zenjs/util/str/unescape"], function() {
    var e = window.Zepto || window.jQuery || e, t = window._global || {}, n = t.share || {}, i = function(e) {
        ...
        var t = "http://static.koudaitong.com/v2/image/wap/logo.png", n = e("#wxcover"), i = null;
        ...
        var e, t = document.documentURI, n = Number(_global.kdt_id) || 0, i = [2737501, 618192, 618242, 371189, 1], o = _global.youzan_share, r = Math.floor(9e3 * Math.random()) + 1e3;
        return i.indexOf(n) >= 0 && (n = 0), o ? (e = r + "." + o, t = t.replace(/:\/\/.*\.koudaitong\.com/g, "://" + e + ".koudaitong.com")) : (e = 0 === n ? "192168-" + r : 192168 + n, t = t.replace("://wap.", "://shop" + e + ".")), t = zenjs.Args.remove(t, "redirect_count")
    }, a = function() {
        ...
        return function() {
            ...
            return i = o.length > 0 ? o.val() || o.text() : n.timeline_title, {title: zenjs.Str.unescape(t),link: a,img_url: s,desc: zenjs.Str.unescape(l).substring(0, 80),timeLineTitle: zenjs.Str.unescape((i || "").trim())}
        }
    }(), s = function() {
        ...
        if (t)
            if (t.isIOS()) {
                ...
                t.isAndroid() && window.android && window.android.sharePlatsAction && window.android.sharePlatsAction(e.title, e.link, e.img_url)
    };
    window.shareHook = s, window.getShareData = window.getShareData || a
}), define("components/zenjs/class", ["require", "exports", "module"], function(e, t, n) {
    ...
    r.extend = function(e) {
        ...
        i = !1;
        for (var a in e)
            r[a] = "function" == typeof e[a] && "function" == typeof n[a] && o.test(e[a]) ? function(e, t) {
                return function() {
                    var i = this._super;
                    this._super = n[e];
...
}), define("components/zenjs/core/trigger_method", [], function() {
    var e = function() {
        function e(e, t, n) {
    ...
    return e
}), define("components/zenjs/events", ["require", "exports", "module", "components/zenjs/class", "components/zenjs/core/trigger_method"], function(e, t, n) {
    var i = e("components/zenjs/class"), o = e("components/zenjs/core/trigger_method"), r = i.extend({on: function(e, t, n) {
            return this._events = this._events || {}, this._events[e] = this._events[e] || [], this._events[e].push({callback: t,context: n,ctx: n || this}), this
        },off: function(e, t, n) {
            var i, o, r, a, s, l, c, d;
            if (!e && !t && !n)
                return this._events = {}, this;
            for (a = e ? [e] : Object.keys(this._events), s = 0, l = a.length; l > s; s++)
                if (e = a[s], r = this._events[e]) {
                    if (this._events[e] = i = [], t || n)
                        for (c = 0, d = r.length; d > c; c++)
                            o = r[c], (t && t !== o.callback && t !== o.callback._callback || n && n !== o.context) && i.push(o);
            ...
            if (n)
                for (var i, o = -1; ++o < n.length; )
                    (i = n[o]).callback.apply(i.ctx, t)
        },triggerMethod: o});
    n.exports = r
}), define("wap/base/js_bridge", ["require", "components/zenjs/util/args", "components/zenjs/util/ua", "wap/base/share", "components/zenjs/events"], function(e) {
    var t = window.Zepto || window.jQuery || t;
    e("components/zenjs/util/args"), e("components/zenjs/util/ua"), e("wap/base/share");
    var n = e("components/zenjs/events"), i = window.zenjs.UA, o = window.zenjs.Args, r = window.getShareData, a = n.extend({init: function(e) {
    ...
    window.onReady("isReadyForYouZanJSBridge", function() {
        ...
        window.YouzanJSBridge = new a({check_login: _global.ajax_acl_check || e.isNeedCheckLogin,fans_token: _global.fans_token,redirectUrl: e.redirectUrl})
    })
    ...
    var e = navigator.userAgent, t = ["MI", "NX507J", "SM701"], n = function() {
        for (var n = t.length - 1; n >= 0; n--)
            if (e.indexOf(t[n]) > -1)
                return !0;
        return !1
    }(), i = "atuo-footer-off", o = 0 === $("." + i).length ? !1 : !0, r = function() {
        var e = $(window).height(), t = $(".container > .content"), n = $(".footer").length && $(".footer").outerHeight(!0) || 0, i = $(".container > .header"), o = $(".js-footer-auto-ele"), r = e, a = $(".js-footer-hide");
        if (0 !== t.length) {
            0 === a.length && (r -= n), i.length > 0 && (r -= i.outerHeight(!0)), o.length > 0 && (r -= o.outerHeight(!0)), t.css("min-height", r + "px");
            var s = +t.outerHeight(!0) - r;
            s > 0 && t.css("min-height", r - s + "px")
        }
    };
    o || n || r()
}), define("wap/base/base", ["wap/base/log", "components/zenjs/util/ua"], function() {
    document.addEventListener("click", function() {
    }, !0);
    var e = window.Zepto || window.jQuery || e;
    e.kdt = e.kdt || {};
    window.zenjs.UA;
    e.extend(e.kdt, {openLink: function(e, t) {
            if (void 0 !== e && null !== e)
                if (t = t || !1) {
...
}), require(["wap/base/fullguide", "vendor/fastclick_release", "wap/base/log", "wap/base/lazy_load", "wap/base/js_bridge", "wap/base/wx", "wap/base/motify", "wap/components/footer_auto", "wap/base/base"], function() {
    var e = function() {
    ...
    "object" != typeof window.localStorage || localStorage.getItem("canwebp") || t(function(e) {
