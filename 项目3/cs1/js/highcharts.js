(function() {
    ...
    function Gd(a, b) {
        function c(m, i) {
            ...
            function Ma() {
                ...
                if (F) {
                    ...
                    k = 6048E5 / rb;
                    q = 2592E6 / rb;
                    var ma = 31556952E3 / rb
                      , s = [["second", G, [1, 2, 5, 10, 15, 30]], ["minute", V, [1, 2, 5, 10, 15, 30]], ["hour", Ba, [1, 2, 3, 4, 6, 8, 12]], ["day", U, [1, 2]], ["week", k, [1, 2]], ["month", q, [1, 2, 3, 4, 6]], ["year", ma, null]]
                      , W = s[6]
                      , ba = W[1]
                      , ia = W[2];
            ...
            y.prototype = {
                addLabel: function() {
                    var k = this.pos
                      , o = i.labels
                      , r = !(k === ca && !C(i.showFirstLabel, 1) || k === fa && !C(i.showLastLabel, 0))
                      , q = Xa && z && Xa.length && !o.step && !o.staggerLines && !o.rotation && Ca / Xa.length || !z && Ca / 2
                      , A = this.label;
                    k = $d.call({
                        isFirst: k === ta[0],
                    ...
                    q = pa(q, o.style);
                    if (A === Va)
                        this.label = M(k) && r && o.enabled ? ga.text(k, 0, 0).attr({
                            align: o.align,
                            rotation: o.rotation
                        }).css(q).add(gc) : null;
                    else
                ...
                render: function(k, o) {
                    var r = !this.minor
                      ...
                      , U = i.labels
                      , G = this.gridLine
                      , V = r ? i.gridLineWidth : i.minorGridLineWidth
                      , Ba = r ? i.gridLineColor : i.minorGridLineColor
                      , ma = r ? i.gridLineDashStyle : i.minorGridLineDashStyle
                      , s = this.mark
                      , W = r ? i.tickLength : i.minorTickLength
                      , ba = r ? i.tickWidth : i.minorTickWidth || 0
                      , ia = r ? i.tickColor : i.minorTickColor
                      , zb = r ? i.tickPosition : i.minorTickPosition;
                    r = U.step;
                    var lb = o && Pc || Ua, Nb;
            ...
            Q.prototype = {
                ...
                render: function(k) {
                    ...
                    if (this.label)
                        ...
                        this.label = m.renderer.text(o, 0, 0).css(this.options.style).attr({
                ...
                setOffset: function(k, o) {
                    var r = this.isNegative
                      , q = v.translate(this.total)
                      , A = v.translate(0);
                    A = $a(q - A);
                    var U = m.xAxis[0].translate(this.x) + k
                      , G = m.plotHeight;
                    r = {
                        x: qa ? r ? q : q - A : U,
        ...
        function e(m) {
            ...
            var t = ga.g("tooltip").attr({
              ...
              , v = ga.rect(Ra, Ra, 0, 0, m.borderRadius, na).attr({
                fill: m.backgroundColor,
                "stroke-width": na
            }).add(t).shadow(m.shadow)
              , N = ga.text("", Qa + Ra, ja(Ma.fontSize) + Qa + Ra).attr({
                zIndex: 1
            }).css(Ma).add(t);
            t.hide();
            return {
                ...
                refresh: function(F) {
                    ...
                    if (ua === false || !$)
                        ...
                        v.attr({
                            width: Ga,
                            height: Ka,
                            stroke: m.borderColor || F.color || Q.color || "#606060"
                        });
                        $ = H - Ga + Y - 25;
                        P = P - Ka + ha + 10;
                        if ($ < 7)
            ...
            function x(z) {
                ...
                u(db, function(t) {
                    ...
                    Z[N ? "xAxis" : "yAxis"].push({
                        axis: t,
                        value: v((qa ? !N : N) ? z.chartX - Y : xa - z.chartY + ha, true)
                    })
                });
                return Z
            }
                    ...
                    if (Ma) {
                        u(db, function(N) {
                            var F = N.translate
                              , H = N.isXAxis
                              , P = qa ? !H : H
                              , $ = F(P ? t : xa - v - Z.height, true, 0, 0, 1);
                        ...
                        if (nd && t.type !== "touchstart") {
                            ...
                            if (Ma > 10) {
                                if (lc && (Ra || Za) && kc(O - Y, ea - ha))
                                    Aa || (Aa = ga.rect(Y, ha, Ga ? 1 : Ca, Ka ? 1 : xa, 0).attr({
        ...
        function g(m) {
            var i = m.type || w.type || w.defaultSeriesType
              , y = vb[i]
              , x = p.hasRendered;
            if (x)
                if (qa && i === "column")
        ...
        function J() {
            ...
            p.container = ya = ib(Qb, {
                className: "highcharts-container" + (w.className ? " " + w.className : ""),
                id: Pd
            }, pa({
                position: Qd,
                overflow: ub,
        ...
        function D() {
            function m() {
                var y = w.width || mb.offsetWidth
                  , x = w.height || mb.offsetHeight;
                if (y && x) {
                    if (y !== Uc || x !== xc) {
                        clearTimeout(i);
            ...
            function x() {
                u(Qa, function(L) {
                    var ka = L.checkbox
                      , T = fb.alignAttr;
                    ka && Na(ka, {
                        left: T.translateX + L.legendItemWidth + ka.x - 40 + bb,
            ...
            function Q(L) {
                ...
                if (!Ja) {
                    ...
                    if (Fa)
                        ...
                        ka = ga.symbol(L.symbol, T = -Ma / 2 - Aa, ra = -4, Oa.marker.radius).attr({
                            zIndex: 3
                        }).add(fb);
                    if (ka) {
                        ka.xOff = T + fa % 2 / 2;
            ...
            function na() {
                ...
                if (oa || ua) {
                    ...
                    if ($)
                        ...
                        $ = ga.rect(0, 0, Wb, Xb, O.borderRadius, oa || 0).attr({
        ...
        pd = function() {
            ...
            if (m || i)
                if (Xc)
                    ...
                    Xc = ga.rect(Q / 2, Q / 2, Ya - Q, Ua - Q, w.borderRadius, m).attr({
    ...
    if (!la && cb.jQuery) {
        ...
        var ce = jQuery.fx.step._default
          , de = jQuery.fx.prototype.cur;
            ...
            updateTransform: function() {
                if (this.added) {
                    ...
                    if (b.tagName === "SPAN") {
                        ...
                        var E = a.xCorr || 0
                          , da = a.yCorr || 0
                          , w = [c, g, b.innerHTML, a.textWidth].join(",");
                        if (w !== a.cTT) {
                            if (M(c)) {
                                l = c * Ud;
                                d = nb(l);
                                D = Db(l);
                                Na(b, {
                                    filter: c ? ["progid:DXImageTransform.Microsoft.Matrix(M11=", d, ", M12=", -D, ", M21=", D, ", M22=", d, ", sizingMethod='auto expand')"].join("") : jb
                                })
                            }
                            l = b.offsetWidth;
                            n = b.offsetHeight;
    ...
    pb.prototype = {
        ...
        drawDataLabels: function() {
            if (this.options.dataLabels.enabled) {
                ...
                var J = l === "column" || l === "bar"
                  , D = e.verticalAlign === null
                  , aa = e.y === null;
                if (J)
                    if (n) {
                        if (D)
                ...
                u(d, function(E) {
                    ...
                    if (B) {
                        ...
                        B = E.dataLabel = h.renderer.text(f, b, c).attr({
                            align: K,
                            rotation: e.rotation,
                            zIndex: 1
                        }).css(e.style).add(g);
                        j && !e.y && B.attr({
                            y: c + ja(B.styles.lineHeight) * 0.9 - B.getBBox().height / 2
                        })
                    }
    ...
    var ad = yb(pb, {
        ...
        translate: function() {
            ...
            var aa = (h - 2 * D) / f
              , E = c.pointWidth
              , da = M(E) ? (aa - E) / 2 : aa * c.pointPadding
              , w = Ha(C(E, aa - 2 * da), 1)
              , R = da + (D + ((g ? f - a.columnIndex : a.columnIndex) || 0) * aa - h / 2) * (g ? -1 : 1)
              , B = a.yAxis.getThreshold(c.threshold || 0)
              , K = C(c.minPointLength, 5);
            u(J, function(S) {
                ...
                S.shapeType = "rect";
                I = pa(b.renderer.Element.prototype.crisp.apply({}, [e, Da, gb, w, wb]), {
                    r: c.borderRadius
                });
                if (e % 2) {
                    I.y -= 1;
                ...
                if (l.y !== null)
                    if (e)
                        ...
                        l.tracker = c[l.shapeType](d).attr({
                            ...
                            visibility: a.visible ? Ab : ub,
                            zIndex: 1
                        }).on(Jb ? "touchstart" : "mouseover", function(n) {
